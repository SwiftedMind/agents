...
@Codable @CodingKeys(.snake_case) public struct Response: Identifiable, Sendable {
  ...
  // Aggregated function calls from the output
  public var outputFunctionCalls: [Item.FunctionCall] {
    output.compactMap { output -> Item.FunctionCall? in
